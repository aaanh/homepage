  ...
  return (
    <section className="gap-2 grid lg:grid-cols-2 mx-4 py-8 border-foreground border-y">
      <a
        ...
        className="flex justify-center items-center bg-card/70 hover:bg-accent/40 backdrop-blur-2xl p-4 h-[200px] text-4xl text-center transition-all ease-in-out"
      >
